...
void memory_hierarchy_c::init(config_c& config) {
  ...
  // TODO: Add other cases (SINGLE_LEVEL, MULTI_LEVEL), instantiate caches and configure neighbors
}
...
void memory_hierarchy_c::run_a_cycle() {
  ////////////////////////////////////////////////////////////////////
  // TODO: Write the code to implement this function
  // 1. Tick a a_cycle for each cache/memory component
