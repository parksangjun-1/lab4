...
public:
  ...
  ///////////////////////////////////////////////////////////////////
  std::vector<int> LRUstack;            //int vector가 더 적당할 것 같긴 함. 
...
public:
 ...
 ///////////////////////////////////////////////////////////////////
 // TODO: You can add some helper functions and information variables (is_evict, is_wb...etc)
 // Write the code for the interface with cache.cc, for part 2. You can add member variables or functions. (It is your design choice)
 ///////////////////////////////////////////////////////////////////
